  ...
  return (
    ...
    >
      ...
      <button onClick={(e) => { e.stopPropagation(); onSave(job.id); }}
        style={{ position: "absolute", top: 12, right: 12, width: 28, height: 28, borderRadius: 6, background: job.saved ? T.accent : "transparent", border: `1px solid ${job.saved ? T.accent : T.border2}`, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", transition: "all 0.15s" }}>
      ...
      <div onClick={() => onClick(job)}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 10, paddingRight: 34 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontFamily: "'Clash Display',sans-serif", fontSize: 14, fontWeight: 600, color: T.text, lineHeight: 1.3, marginBottom: 2 }}>{job.title}</div>
