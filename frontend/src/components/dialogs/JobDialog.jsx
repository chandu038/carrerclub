  ...
  return (
    ...
    >
      <div style={{
        ...
        overflowY: "auto",
        animation: "dlg 0.28s cubic-bezier(0.34,1.4,0.64,1)",
      }}>
...
export default function JobDialog({ job, onClose, onSave, T, isMobile }) {
  ...
  return (
    <Dialog onClose={onClose} T={T} isMobile={isMobile}>
      {/* ── HEADER ── */}
      <div style={{
        background: `linear-gradient(135deg, ${T.ms1}, ${T.ms3})`,
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ fontFamily: "'Clash Display',sans-serif", fontSize: isMobile ? 17 : 21, fontWeight: 700, letterSpacing: -0.5, lineHeight: 1.2, color: T.text }}>
                {job.title}
              </div>
          ...
          <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
            <button onClick={() => onSave(job.id)} style={{
              ...
              background: job.saved ? T.accent : T.bg3,
        ...
        <div style={{ display: "flex", gap: 7, flexWrap: "wrap", marginTop: "1rem" }}>
          ...
          <span style={{ background: T.ms2, color: T.a3, border: `1px solid ${T.border}`, fontSize: 11, fontWeight: 700, padding: "4px 11px", borderRadius: 20 }}>
      ...
      <div style={{ padding: "0 1.25rem 1.75rem" }}>
        {job.tags?.length > 0 && (
          <div style={{ background: T.ms1, borderRadius: 10, padding: "0.85rem 1rem", margin: "1rem 0 0" }}>
            ...
            <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
              {job.tags.map((t) => (
                <span key={t} style={{ background: T.bg3, border: `1px solid ${T.border2}`, padding: "4px 12px", borderRadius: 20, fontSize: 12, color: T.text }}>
                  {t}
                </span>
              ))}
            </div>
        ...
        {/* Apply */}
        {job.applyLink ? (
          <a href={job.applyLink} target="_blank" rel="noreferrer" style={{
            display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
            width: "100%", padding: 14, borderRadius: 10, marginTop: "1rem",
            background: job.cat === "govt"
              ? `linear-gradient(135deg,${T.a6},${T.a3})`
              : `linear-gradient(135deg,${T.a3},${T.a4})`,
            color: "#fff", fontSize: 15, fontWeight: 700,
            textDecoration: "none", fontFamily: "'Clash Display',sans-serif",
          ...
          <div style={{
            ...
            color: T.text3, fontSize: 14, fontFamily: "'Satoshi',sans-serif",
          }}>
