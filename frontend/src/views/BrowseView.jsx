...
export default function BrowseView({ jobs, T, isMobile, setSelJob, onSave }) {
  ...
  // When URL changes (e.g. /browse/govt) update the cat filter
  useEffect(() => {
    ...
    <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "1.5rem 2rem 0", borderBottom: `1px solid ${T.border}` }}>
        <div style={{ fontFamily: "'Clash Display',sans-serif", fontSize: 24, fontWeight: 700, color: T.text, marginBottom: "1rem", display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontSize: 14, fontWeight: 400, color: T.text2 }}>
            ({filtered.length})
          </span>
        </div>
        ...
        <div style={{ position: "relative", marginBottom: "1rem" }}>
          ...
          <input
            ...
            style={{
              ...
              fontSize: 14, color: T.text, width: "100%",
          ...
          {CATS.map((c) => {
            ...
            return (
              <button key={c.id} onClick={() => handleCatChange(c.id)}
                style={{
                  flexShrink: 0, padding: "9px 14px", fontSize: 12, fontWeight: 600,
          ...
          {["all", "Full-time", "Internship", "Part-time", "Contract", "Govt"].map((t) => (
            <button key={t} onClick={() => setTypeFilter(t)}
              style={{
                ...
                border: `1px solid ${typeFilter === t ? T.border2 : T.border}`,
                background: typeFilter === t ? T.bg3 : "transparent",
                color: typeFilter === t ? T.text : T.text2,
              }}>
              {t === "all" ? "All types" : t}
      ...
      <div style={{ padding: isMobile ? "1rem" : "1.5rem 2rem", flex: 1 }}>
        {filtered.length > 0 ? (
          ...
          <div style={{ textAlign: "center", padding: "5rem 1rem" }}>
            ...
            <div style={{ fontFamily: "'Clash Display',sans-serif", fontSize: 20, fontWeight: 600, color: T.text, marginBottom: 8, marginTop: 16 }}>
              No jobs found
            </div>
            ...
            <button
              onClick={() => { setSearch(""); setTypeFilter("all"); handleCatChange("all"); }}
