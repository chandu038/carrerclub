...
export default function HomeView({ jobs, T, isMobile, setSelJob, onSave }) {
  ...
  return (
    <div style={{ flex: 1, minWidth: 0 }}>
      ...
      {/* ── HERO ── */}
      <div style={{ position: "relative", overflow: "hidden", padding: isMobile ? "3rem 1.5rem 2.5rem" : "0", minHeight: isMobile ? "auto" : 520, display: "flex", alignItems: "stretch" }}>
        ...
        <div style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: 1280, margin: "0 auto", padding: isMobile ? "0" : "4rem 3rem", display: "flex", alignItems: "center", gap: isMobile ? 0 : "4rem", flexDirection: isMobile ? "column" : "row" }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
              <button onClick={() => navigate("/browse")}
                style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "13px 28px", borderRadius: 12, background: `linear-gradient(135deg,${T.a3},${T.a4})`, color: "#fff", fontSize: 14, fontWeight: 700, border: "none", cursor: "pointer", fontFamily: "'Clash Display',sans-serif", boxShadow: `0 8px 28px ${T.a3}44`, transition: "transform 0.15s,box-shadow 0.15s" }}
              ...
              <button onClick={() => navigate("/browse/govt")}
                style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "13px 24px", borderRadius: 12, background: T.gbBg, color: T.a6, fontSize: 14, fontWeight: 700, border: `1px solid ${T.a6}44`, cursor: "pointer", fontFamily: "'Clash Display',sans-serif", transition: "transform 0.15s" }}
          ...
          {w > 860 && (
            <div style={{ width: 440, flexShrink: 0, position: "relative" }}>
              <div style={{ width: "100%", height: 400, borderRadius: 28, background: `linear-gradient(135deg,${T.bg2},${T.bg3})`, border: `1px solid ${T.border2}`, display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden", boxShadow: `0 24px 80px rgba(0,0,0,0.25)` }}>
      ...
      <div style={{ padding: isMobile ? "1.5rem 1rem" : "2.5rem 3rem", maxWidth: 1280, margin: "0 auto", width: "100%" }}>
        ...
        {recent.length > 0 && (
          <div style={{ marginBottom: "2.5rem", background: T.bg2, border: `1px solid ${T.border}`, borderRadius: 14, padding: "1rem" }}>
              ...
              {[...recent, ...recent].map((j, i) => {
                ...
                return (
                  <div key={i} onClick={() => setSelJob(j)}
                    style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0, position: "relative", background: T.bg3, border: `1px solid ${_isNew ? "#ff527966" : T.border2}`, borderRadius: 10, padding: "8px 12px", cursor: "pointer", transition: "border-color 0.15s", minWidth: isMobile ? 195 : 215 }}
                    ...
                    <div style={{ minWidth: 0, flex: 1 }}>
                      <div style={{ fontFamily: "'Clash Display',sans-serif", fontSize: 12, fontWeight: 600, color: T.text, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", maxWidth: 110 }}>{j.title}</div>
        ...
        <div style={{ marginBottom: "2rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "repeat(2,1fr)" : w < 900 ? "repeat(3,1fr)" : "repeat(4,1fr)", gap: 12 }}>
            {CATS.slice(1).map((c) => {
              ...
              return (
                <button key={c.id} onClick={() => navigate(`/browse/${c.id}`)}
